...
public abstract class PassphraseRequiredActionBarActivity extends BaseActionBarActivity {
    ...
    private static final String TAG = "ACL"; //PassphraseRequiredActionBarActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.i(TAG, "onCreate(" + savedInstanceState + ") - WE ARE HEREEEEEEEEEEEEe!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        super.onCreate(savedInstanceState);

        //onPreCreate();

        if (savedInstanceState != null) {
            final Intent externalShareIntent = savedInstanceState.getParcelable("next_intent");
            ...
            Log.w(TAG, "Got a null savedInstanceState - can't work w/ dis... =/");
        }
